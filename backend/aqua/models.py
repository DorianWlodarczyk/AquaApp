...
class AquaAccount(models.Model):
    id_aqua_account = models.IntegerField(primary_key=True)
    user_mail = models.CharField(max_length=60)
    user_token = models.IntegerField(blank=True, null=True)
...
class AquaDecorator(models.Model):
    id_aqua_decorator = models.IntegerField(primary_key=True)
...
class AquaHistory(models.Model):
    id_aqua_history = models.IntegerField(primary_key=True)
...
class AquaLife(models.Model):
    id_aqua_life_fish = models.IntegerField(primary_key=True)
...
class AquaMaker(models.Model):
    id_aqua_maker = models.IntegerField(primary_key=True)
...
class AquariumTank(models.Model):
    id_aquarium_tank = models.IntegerField(primary_key=True)
...
class Asset(models.Model):
    id_asset = models.IntegerField(primary_key=True)
...
class Fish(models.Model):
    id_fish = models.IntegerField(primary_key=True)
...
class FishConflict(models.Model):
    id_fish_conflict = models.IntegerField(primary_key=True)
    id_first_fish = models.ForeignKey(Fish, models.PROTECT, db_column='id_first_fish', blank=True, null=True)
    id_second_fish = models.ForeignKey(Fish, models.PROTECT, db_column='id_second_fish', blank=True, null=True)
...
class Ground(models.Model):
    id_ground = models.IntegerField(primary_key=True)
...
class Heater(models.Model):
    id_heater = models.IntegerField(primary_key=True)
...
class Lamp(models.Model):
    id_lamp = models.IntegerField(primary_key=True)
...
class Plant(models.Model):
    id_plant = models.IntegerField(primary_key=True)
...
class Pump(models.Model):
    id_pump = models.IntegerField(primary_key=True)
...
class TankObject(models.Model):
    id_tank_object = models.IntegerField(primary_key=True)
