...
urlpatterns = [
    ...
    path("admin/conflicts/<int:firstID>/<int:secondID>",views.remove_fish_conflict,name="remove_fish_conflic"),
    ...
    path("aquarium_edit/<aquariumID>", views.edit_aquarium, name="edit_aquarium"),
