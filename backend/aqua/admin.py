...
class TankObjectAdmin(admin.ModelAdmin):
    list_display = ('id_tank_object', 'id_aqua_decorator', 'id_aqua_maker', 'id_aqua_account', 'tank_name', 'id_tank_picture', 'is_favourite_tank')
...
class AquaMakerAdmin(admin.ModelAdmin):
    list_display = ('id_aqua_maker', 'id_aquarium_tank', 'id_heater', 'id_pump', 'id_lamp')
...
class AquaLifeAdmin(admin.ModelAdmin):
    list_display = ('id_aqua_life_fish', 'id_fish', 'id_fish_life_time', 'id_tank_object', 'fish_life_status')


@admin.register(AquariumTank)
class AquariumTankAdmin(admin.ModelAdmin):
    list_display = ('id_aquarium_tank', 'size_width', 'size_height', 'size_length')
...
class FishAdmin(admin.ModelAdmin):
    list_display = ('id_fish', 'fish_name', 'fish_size', 'min_ph', 'max_ph', 'min_degree', 'max_degree', 'fish_character', 'info')
...
class HeaterAdmin(admin.ModelAdmin):
    list_display = ('id_heater', 'heater_name', 'heater_min_power', 'heater_max_power', 'min_capacity', 'max_capacity')
...
class PumpAdmin(admin.ModelAdmin):
    list_display = ('id_pump', 'pump_name', 'power', 'pump_capacity', 'water_gauge')
